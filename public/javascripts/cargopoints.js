    ...
    $('#loadingButton p').live ('click',
        function addLoadingBlock() {
            ...
            if (tbody.length) {
                ...
                htmlDate += "<input type='text' name='loadingDate"+nextId+"' id='loadingDate"+nextId+"' value='' class='ddate' size='10'> до: <input type='text' size='5' class='inp' value='' id='loadingTime"+nextId+"' name='loadingTime"+nextId+"'></td>\n</td>\n"
                ...
                htmlAddress += "<input type='text' name='loadingAddress"+nextId+"' id='loadingAddress"+nextId+"' value='' class='inp' size='25'></td>\n"
                ...
                htmlCompany += "<input type='text' name='shipper"+nextId+"' id='shipper"+nextId+"' value='' class='inp' size='25'></td>\n"
                ...
                htmlPerson += "<input type='text' name='loadingContactPerson"+nextId+"' id='loadingContactPerson"+nextId+"' value='' class='inp' size='25'></td>\n"
                ...
                htmlMobile += "<input type='text' name='loadingContactPhone"+nextId+"' id='loadingContactPhone"+nextId+"' value='' class='inp' size='25'></td>\n"
                ...
                htmlWorkPhone += "<input type='text' name='loadingContactPhoneWork"+nextId+"' id='loadingContactPhoneWork"+nextId+"' value='' class='inp' size='25'></td>\n"
                ...
                html +=            "<input type='text' name='loadingDate"+nextId+"' id='loadingDate"+nextId+"' value='' class='ddate' size='10'> до: <input type='text' size='5' class='inp' value='' id='loadingTime"+nextId+"' name='loadingTime"+nextId+"'></td>\n</td>\n"
                ...
                html +=            "<input type='text' name='loadingAddress"+nextId+"' id='loadingAddress"+nextId+"' value='' class='inp' size='25'></td>\n"
                ...
                html +=            "<input type='text' name='shipper"+nextId+"' id='shipper"+nextId+"' value='' class='inp' size='25'></td>\n"
                ...
                html +=            "<input type='text' name='loadingContactPerson"+nextId+"' id='loadingContactPerson"+nextId+"' value='' class='inp' size='25'></td>\n"
                ...
                html +=            "<input type='text' name='loadingContactPhone"+nextId+"' id='loadingContactPhone"+nextId+"' value='' class='inp' size='25'></td>\n"
                ...
                html +=            "<input type='text' name='loadingContactPhoneWork"+nextId+"' id='loadingContactPhoneWork"+nextId+"' value='' class='inp' size='25'></td>\n"
    ...
    $('#unloadingButton p').live ('click',
        function addUnloadingBlock() {
            ...
            if (tbody.length) {
                ...
                htmlDate += "<input type='text' name='unloadingDate"+nextId+"' id='unloadingDate"+nextId+"' value='' class='ddate' size='10'> до: <input type='text' size='5' class='inp' value='' id='unloadingTime"+nextId+"' name='unloadingTime"+nextId+"'></td>\n</td>\n"
                ...
                htmlAddress += "<input type='text' name='unloadingAddress"+nextId+"' id='unloadingAddress"+nextId+"' value='' class='inp' size='25'></td>\n"
                ...
                htmlCompany += "<input type='text' name='consignee"+nextId+"' id='consignee"+nextId+"' value='' class='inp' size='25'></td>\n"
                ...
                htmlPerson += "<input type='text' name='unloadingContactPerson"+nextId+"' id='unloadingContactPerson"+nextId+"' value='' class='inp' size='25'></td>\n"
                ...
                htmlMobile += "<input type='text' name='unloadingContactPhone"+nextId+"' id='unloadingContactPhone"+nextId+"' value='' class='inp' size='25'></td>\n"
                ...
                htmlWorkPhone += "<input type='text' name='unloadingContactPhoneWork"+nextId+"' id='unloadingContactPhoneWork"+nextId+"' value='' class='inp' size='25'></td>\n"
                ...
                html +=            "\t\t<input type='text' name='unloadingDate"+nextId+"' id='unloadingDate"+nextId+"' value='' class='ddate' size='10'> до: <input type='text' size='5' class='inp' value='' id='unloadingTime"+nextId+"' name='unloadingTime"+nextId+"'></td>\n\n"
                html +=        "\t</tr>\n"
                html +=        "\t<tr>\n"
                ...
                html +=            "\t\t<input type='text' name='unloadingAddress"+nextId+"' id='unloadingAddress"+nextId+"' value='' class='inp' size='25'></td>\n"
                html +=        "\t</tr>\n"
                html +=        "\t<tr>\n"
                ...
                html +=            "\t\t<input type='text' name='consignee"+nextId+"' id='consignee"+nextId+"' value='' class='inp' size='25'></td>\n"
                html +=        "\t</tr>\n"
                html +=        "\t<tr>\n"
                ...
                html +=            "\t\t<input type='text' name='unloadingContactPerson"+nextId+"' id='unloadingContactPerson"+nextId+"' value='' class='inp' size='25'></td>\n"
                html +=        "\t</tr>\n"
                html +=        "\t<tr>\n"
                ...
                html +=            "\t\t<input type='text' name='unloadingContactPhone"+nextId+"' id='unloadingContactPhone"+nextId+"' value='' class='inp' size='25'></td>\n"
                html +=        "\t</tr>\n"
                html +=        "\t<tr>\n"
                ...
                html +=            "\t\t<input type='text' name='unloadingContactPhoneWork"+nextId+"' id='unloadingContactPhoneWork"+nextId+"' value='' class='inp' size='25'></td>\n"
                html +=        "\t</tr>\n"
                html +=        "\t<tr>\n"
