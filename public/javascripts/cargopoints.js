    ...
    $('#loadingButton p').live ('click',
        function addLoadingBlock() {
            ...
            if (tbody.length) {
                ...
                htmlDate += "<input type='text' name='request[loading_points_attributes]["+nextId+"][date]' id='loadingDate"+nextId+"' value='' class='inp ddateshort' size='10'> до: <input type='text' size='5' class='inp' value='' id='request[loading_point"+nextId+"][time]' name='request[loading_points_attributes]["+nextId+"][time]'></td></td>\n"
                ...
                htmlAddress += "<input type='text' name='request[loading_points_attributes]["+nextId+"][date]' id='loadingAddress"+nextId+"' value='' class='inp' size='25'><span style='color: red; font-size:16px;'>*</span></td>\n"
                ...
                htmlCompany += "<input type='text' name='request[loading_points_attributes]["+nextId+"][shipper]' id='shipper"+nextId+"' value='' class='inp' size='25'><span style='color: red; font-size:16px;'>*</span></td>\n"
                ...
                htmlPerson += "<input type='text' name='request[loading_points_attributes]["+nextId+"][contact_person]' id='loadingContactPerson"+nextId+"' value='' class='inp' size='25'><span style='color: red; font-size:16px;'>*</span></td>\n"
                ...
                htmlMobile += "<input type='text' name='request[loading_points_attributes]["+nextId+"][phone]' id='loadingContactPhone"+nextId+"' value='' class='inp' size='25'><span style='color: red; font-size:16px;'>*</span></td>\n"
                ...
                htmlWorkPhone += "<input type='text' name='request[loading_points_attributes]["+nextId+"][phone_work]' id='loadingContactPhoneWork"+nextId+"' value='' class='inp' size='25'></td>\n"
                ...
                html +=            "<input type='text' name='request[loading_points_attributes]["+nextId+"][date]' id='loadingDate"+nextId+"' value='' class='inp ddateshort required_without_val' size='10'> до: <input type='text' size='5' class='inp' value='' id='request[loading_point"+nextId+"][time]' name='request[loading_points_attributes]["+nextId+"][time]'></td></td>\n"
                ...
                html +=            "<input type='text' name='request[loading_points_attributes]["+nextId+"][address]' id='loadingAddress"+nextId+"' value='' class='inp required_without_val' size='25'><span style='color: red; font-size:16px;'>*</span></td>\n"
                ...
                html +=            "<input type='text' name='request[loading_points_attributes]["+nextId+"][shipper]' id='shipper"+nextId+"' value='' class='inp required_without_val' size='25'><span style='color: red; font-size:16px;'>*</span></td>\n"
                ...
                html +=            "<input type='text' name='request[loading_points_attributes]["+nextId+"][contact_person]' id='loadingContactPerson"+nextId+"' value='' class='inp required_without_val' size='25'><span style='color: red; font-size:16px;'>*</span></td>\n"
                ...
                html +=            "<input type='text' name='request[loading_points_attributes]["+nextId+"][phone]' id='loadingContactPhone"+nextId+"' value='' class='inp required_without_val' size='25'><span style='color: red; font-size:16px;'>*</span></td>\n"
    ...
    $('#unloadingButton p').live ('click',
        function addUnloadingBlock() {
            ...
            if (tbody.length) {
                ...
                htmlDate += "<input type='text' name='request[unloading_points_attributes]["+nextId+"][date]' id='unloadingDate"+nextId+"' class='inp ddateshort' size='10'> до: <input type='text' size='5' class='inp' value='' id='request[unloading_point"+nextId+"][time]' name='request[unloading_points_attributes]["+nextId+"][time]'></td></td>\n"
                ...
                htmlAddress += "<input type='text' name='request[unloading_points_attributes]["+nextId+"][address]' id='unloadingAddress"+nextId+"' value='' class='inp required_without_val' size='25'><span style='color:red; font-size:16px;'>*</span></td>"
                ...
                htmlCompany += "<input type='text' name='request[unloading_points_attributes]["+nextId+"][consignee]' id='consignee"+nextId+"' value='' class='inp required_without_val' size='25'><span style='color: red; font-size: 16px;'>*</span></td>\n"
                ...
                htmlPerson += "<input type='text' name='request[unloading_points_attributes]["+nextId+"][contact_person]' id='unloadingContactPerson"+nextId+"' value='' class='inp required_without_val' size='25'><span style='color: red; font-size: 16px;'>*</span></td>\n"
                ...
                htmlMobile += "<input type='text' name='request[unloading_points_attributes]["+nextId+"][phone]' id='unloadingContactPhone"+nextId+"' value='' class='inp required_without_val' size='25'><span style='color: red; font-size: 16px;'>*</span> </td>\n"
                ...
                htmlWorkPhone += "<input type='text' name='request[unloading_points_attributes]["+nextId+"][phone_work]' id='unloadingContactPhoneWork"+nextId+"' value='' class='inp' size='25'></td>\n"
                ...
                html +=            "\t\t<input type='text' name='request[unloading_points_attributes]["+nextId+"][date]' id='unloadingDate"+nextId+"' value='' class='inp ddateshort' size='10'> до: <input type='text' size='5' class='inp' value='' id='request[unloading_point"+nextId+"][time]' name='request[unloading_points_attributes]["+nextId+"][time]'></td></td>"
                html +=        "\t</tr>\n"
                html +=        "\t<tr>\n"
                ...
                html +=            "\t\t<input type='text' name='request[unloading_points_attributes]["+nextId+"][address]' id='unloadingAddress"+nextId+"' value='' class='inp required_without_val' size='25'><span style='color: red; font-size: 16px;'>*</span></td>"
                html +=        "\t</tr>\n"
                html +=        "\t<tr>\n"
                ...
                html +=            "\t\t<input type='text' name='request[unloading_points_attributes]["+nextId+"][consignee]' id='consignee"+nextId+"' value='' class='inp required_without_val' size='25'><span style='color: red; font-size: 16px;'>*</span> </td>\n"
                html +=        "\t</tr>\n"
                html +=        "\t<tr>\n"
                ...
                html +=            "\t\t<input type='text' name='request[unloading_points_attributes]["+nextId+"][contact_person]' id='unloadingContactPerson"+nextId+"' value='' class='inp required_without_val' size='25'><span style='color: red; font-size: 16px;'>*</span> </td>\n"
                html +=        "\t</tr>\n"
                html +=        "\t<tr>\n"
                ...
                html +=            "\t\t<input type='text' name='request[unloading_points_attributes]["+nextId+"][phone]' id='unloadingContactPhone"+nextId+"' value='' class='inp required_without_val' size='25'><span style='color: red; font-size: 16px;'>*</span> </td>\n"
                html +=        "\t</tr>\n"
                html +=        "\t<tr>\n"
