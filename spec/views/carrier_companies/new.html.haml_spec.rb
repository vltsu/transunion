...
describe "carrier_companies/new.html.haml" do
  before(:each) do
    assign(:carrier_company, stub_model(CarrierCompany,
      :title => "MyString",
  ...
  it "renders new carrier_company form" do
    ...
    assert_select "form", :action => carrier_companies_path, :method => "post" do
