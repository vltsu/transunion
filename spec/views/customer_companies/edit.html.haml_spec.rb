...
describe "customer_companies/edit.html.haml" do
  before(:each) do
  ...
  it "renders the edit customer_company form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => customer_companies_path(@customer_company), :method => "post" do
