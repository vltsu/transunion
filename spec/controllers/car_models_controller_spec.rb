...
describe CarModelsController do
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new CarModel" do
        expect {
          post :create, :car_model => valid_attributes
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested car_model" do
        ...
        put :update, :id => car_model.id, :car_model => {'these' => 'params'}
      end

      it "assigns the requested car_model as @car_model" do
        car_model = CarModel.create! valid_attributes
        put :update, :id => car_model.id, :car_model => valid_attributes
        assigns(:car_model).should eq(car_model)
      end
    ...
    describe "with invalid params" do
      it "assigns the car_model as @car_model" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        CarModel.any_instance.stub(:save).and_return(false)
        put :update, :id => car_model.id.to_s, :car_model => {}
        assigns(:car_model).should eq(car_model)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested car_model" do
      car_model = CarModel.create! valid_attributes
      expect {
        delete :destroy, :id => car_model.id.to_s
      }.to change(CarModel, :count).by(-1)
    end
