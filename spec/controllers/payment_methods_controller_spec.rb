...
describe PaymentMethodsController do
  ...
  describe "GET show" do
    it "assigns the requested payment_method as @payment_method" do
      payment_method = PaymentMethod.create! valid_attributes
      get :show, :id => payment_method.id.to_s
  ...
  describe "GET edit" do
    it "assigns the requested payment_method as @payment_method" do
      payment_method = PaymentMethod.create! valid_attributes
      get :edit, :id => payment_method.id.to_s
      assigns(:payment_method).should eq(payment_method)
    end
  end
  ...
  describe "PUT update" do
    ...
    describe "with invalid params" do
      it "assigns the payment_method as @payment_method" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        PaymentMethod.any_instance.stub(:save).and_return(false)
        put :update, :id => payment_method.id.to_s, :payment_method => {}
        assigns(:payment_method).should eq(payment_method)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested payment_method" do
      payment_method = PaymentMethod.create! valid_attributes
      expect {
        delete :destroy, :id => payment_method.id.to_s
      }.to change(PaymentMethod, :count).by(-1)
    end
